...
public class MrcEnglishInquiryFormTest {
	...
	@Test
	public void testMrcEnglishInquiryFormTest() throws Exception {
		driver.get(baseUrl + "/english/inquiry/form.html");
		new Select(driver.findElement(By.id("theme"))).selectByVisibleText("Environment & Safety");
		...
		driver.findElement(By.name("tel")).sendKeys("000-000-000");
		driver.findElement(By.name("fax")).clear();
		driver.findElement(By.name("fax")).sendKeys("000-000-000");
