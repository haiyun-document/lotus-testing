...
public class MrcInquiryFormTest {
	...
	@Test
	public void testMrcInquiryFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/form.html");
		new Select(driver.findElement(By.id("theme"))).selectByVisibleText("採用関連");
		driver.findElement(By.name("subject")).clear();
		driver.findElement(By.name("subject")).sendKeys("件名");
		driver.findElement(By.name("name")).clear();
		driver.findElement(By.name("name")).sendKeys("三菱　太郎");
		driver.findElement(By.name("kana")).clear();
		driver.findElement(By.name("kana")).sendKeys("ミツビシ　タロウ");
		...
		new Select(driver.findElement(By.name("pref"))).selectByVisibleText("宮城県");
