...
public class ConnectyInquiryIntraInputCompanyFormTest {
	...
	@Test
	public void testConnectyInquiryIntraInputCompanyFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/intra/input");
