...
public class ConnectyInquiryCMSInputCompanyFormTest {
	...
	@Test
	public void testConnectyInquiryCMSInputCompanyFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/cms/input");
