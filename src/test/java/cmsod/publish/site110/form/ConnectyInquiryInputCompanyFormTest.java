...
public class ConnectyInquiryInputCompanyFormTest {
	...
	@Test
	public void testConnectyInquiryInputCompanyFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/input");
		new Select(driver.findElement(By.name("inquiryType"))).selectByVisibleText("コネクティの会社に関する問合せ");
