...
public class DoutorInquiryDtrOtherFormTest {
	...
	@Test
	public void testDoutorInquiryDtrOtherFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/dtr/other/index.html");
