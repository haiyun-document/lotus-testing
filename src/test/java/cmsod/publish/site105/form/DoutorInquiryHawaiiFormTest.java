...
public class DoutorInquiryHawaiiFormTest {
	...
	@Test
	public void testDoutorInquiryHawaiiFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/hawaii/index.html");
		driver.findElement(By.name("feedback")).clear();
		driver.findElement(By.name("feedback")).sendKeys("お問い合わせ内容");
