...
public class DoutorInquiryDtrWebsiteFormTest {
	...
	@Test
	public void testDoutorInquiryDtrWebsiteFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/dtr/website/index.html");
