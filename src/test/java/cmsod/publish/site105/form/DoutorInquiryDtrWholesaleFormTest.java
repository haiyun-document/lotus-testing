...
public class DoutorInquiryDtrWholesaleFormTest {
	...
	@Test
	public void testDoutorInquiryDtrWholesaleFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/dtr/wholesale/index.html");
