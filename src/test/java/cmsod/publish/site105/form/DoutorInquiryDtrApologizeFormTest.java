...
public class DoutorInquiryDtrApologizeFormTest {
	...
	@Test
	public void testDoutorInquiryDtrApologizeFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/apologize/index.html");
		driver.findElement(By.name("theme")).click();
		driver.findElement(By.name("feedback")).clear();
		driver.findElement(By.name("feedback")).sendKeys("本件に関するお問合せ");
