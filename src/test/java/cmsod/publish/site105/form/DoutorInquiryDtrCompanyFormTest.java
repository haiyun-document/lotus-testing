...
public class DoutorInquiryDtrCompanyFormTest {
	...
	@Test
	public void testDoutorInquiryDtrCompanyFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/dtr/company/index.html");
