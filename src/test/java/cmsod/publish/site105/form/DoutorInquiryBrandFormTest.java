...
public class DoutorInquiryBrandFormTest {
	...
	@Test
	public void testDoutorInquiryBrandFormTest() throws Exception {
		driver.get(baseUrl + "/inquiry/brand/index.html");
		new Select(driver.findElement(By.id("shopbrand"))).selectByVisibleText("カフェ モッカ");
		driver.findElement(By.xpath("(//input[@name='theme'])[3]")).click();
